...
public class PlaylistActivity extends AppCompatActivity implements TracksAdpter.onClickListner {
    ...
    public void onCreate(Bundle bundle) {
        ...
        AlbumSongList = getPlaylistAudio(getApplicationContext(),_ID);
